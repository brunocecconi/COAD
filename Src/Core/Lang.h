...
concept is_coad_class = 
	eastl::is_same_v<void, eastl::void_t<typename T::coad_class_type>> &&
	eastl::is_same_v<typename T::this_type, T>;
...
#define CLASS_BODY(CLASS_NAME)	\
CLASS_BODY_CUSTOM(CLASS_NAME, CLASS_MOVEABLE(CLASS_NAME), CLASS_COPYABLE(CLASS_NAME))	\
...
CLASS_BODY_CUSTOM(CLASS_NAME, NO_BODY, NO_BODY)
...
static_assert(!eastl::is_polymorphic_v<CLASS_NAME>, \
"The class cannot be polymorphic.");	\
static_assert(!eastl::is_trivially_constructible_v<CLASS_NAME>, \
"The class cannot be trivially constructible.");	\
static_assert(!eastl::is_trivially_destructible_v<CLASS_NAME>, \
"The class cannot be trivially destructible.");	\
TYPE_INFO_DEFINE(CLASS_NAME);	\
TYPE_INFO_DEFINE(eastl::vector<CLASS_NAME>);	\
TYPE_INFO_DEFINE(eastl::set<CLASS_NAME>);
